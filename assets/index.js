$(document).ready(function () {
  // SUBSERVICES SLIDER
  var subservices__slider = $(".subservices__slider");
  subservices__slider.owlCarousel({
    ...
    onDragged: function onDragged(e) {
      ...
      $(e.target).find(".deatailed-btn").on("click", function (e) {
        e.stopPropagation();
        var wrapper = this.closest(".subservices__slider_item");
        $(this).hasClass("back") ? showDesc(wrapper) : showDetails(wrapper);
      });
      $(e.target).find(".buttons__item.detailed").on("click", function (e) {
        e.stopPropagation();
        var wrapper = this.closest(".subservices__slider_item");
        $(this).hasClass("active") ? showDesc(wrapper) : showDetails(wrapper);
      });
      $(e.target).find(".buttons__item.desc").on("click", function (e) {
        e.stopPropagation();
        var wrapper = this.closest(".subservices__slider_item");
  ...
  $(".deatailed-btn").on("click", function (e) {
    e.stopPropagation();
    var wrapper = this.closest(".subservices__slider_item") || this.closest(".subservices__mobile_item");
    $(this).hasClass("back") ? showDesc(wrapper) : showDetails(wrapper);
  });
  ...
  // edoBenefits SLIDER
  var edoBenefits = $(".edo-benefits__right_slider");
  edoBenefits.owlCarousel({
    ...
    onChanged: function onChanged() {
      var itemNumber = $(".edo-benefits__left_nav").find(".edo-benefits__left_nav_item.active").attr("data");
      $(".edo-benefits__left_item").removeClass("active");
      $(".edo-benefits__left_item.item-".concat(itemNumber)).addClass("active");
      $(".edo-benefits__mobile-text_item").removeClass("active");
      $(".edo-benefits__mobile-text_item.item-".concat(itemNumber)).addClass("active");
    }
  });
  $(".edo-benefits__left_nav_item").on("click", function () {
    var itemNumber = $(this).attr("data");
    $(".edo-benefits__left_item").removeClass("active");
    $(".edo-benefits__left_item.item-".concat(itemNumber)).addClass("active");
    $(".edo-benefits__mobile-text_item").removeClass("active");
    $(".edo-benefits__mobile-text_item.item-".concat(itemNumber)).addClass("active");
  ...
  // SOLUTIONS SLIDER
  var solutionsSlider = $(".solutions__slider");
  ...
  $(".solutions__nav_button").on("click", function () {
    solutionsSlider.trigger("stop.owl.autoplay");
  });
  ...
  servicesSlider.owlCarousel({
    ...
    margin: 50,
    onDragged: function onDragged(e) {
      var itemNumber = $(e.target).find(".owl-item.active .services__slider_item").attr("data");
      $(".services__nav_item, .services__text_item").removeClass("active");
      $(".services__nav_item.item-".concat(itemNumber, ", .services__text_item.item-").concat(itemNumber)).addClass("active");
  ...
  $(".services__nav_item").on("click", function () {
    ...
    $(".services__text_item.item-".concat(itemNumber)).addClass("active");
    $(".services__dots-nav_item").removeClass("active");
    $(".services__dots-nav_item.desc").addClass("active");
  });
  $(".services__text_btn").on("click", function () {
    var wrapper = $(this).closest(".services__text_item");
  ...
  $(".services__dots-nav_item").on("click", function () {
    $(".services__dots-nav_item").toggleClass("active");
    $(".services__text_item.active").find(".services__text_desc").toggleClass("active");
    $(".services__text_item.active").find(".services__text_detailed").toggleClass("active");
  });
  // SERVICES SLIDER END
